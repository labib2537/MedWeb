    ...
    <div class="card">
            <div class="card-body bg-blue text-center card-img-top"
                ...
                <div class="card-img-actions d-inline-block mb-3">
                        ...
                        @else
                        <img class="img-fluid rounded-circle" src="{{asset('uploads/images/profiles')}}/{{$user->profile_picture}}"
                        width="170" height="170" alt="">
                        <div class="card-img-actions-overlay card-img rounded-circle">
                ...
                <span class="d-block opacity-75">ADMIN</span>
            ...
            <div class="card-body border-top-0">
                ...
                <div class="d-sm-flex flex-sm-wrap mb-3">
                    ...
                    <div class="ml-sm-auto mt-2 mt-sm-0">{{$user->dateOfBirth ?? 'Your DOB'}}</div>
                </div>
...
<x-sg-usermaster>
    ...
    <div class="card">
            <div class="card-body bg-blue text-center card-img-top"
                ...
                <h6 class="font-weight-semibold mb-0">{{$user->name}}</h6>
                <span class="d-block opacity-75">USER</span>
