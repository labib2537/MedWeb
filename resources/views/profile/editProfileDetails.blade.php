                    ...
                    <form action="{{ route('profile.update2') }}" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input name="dob" type="text" class="form-control" placeholder="EX: 01/01/2000" value="<?=$user->dateOfBirth?>" required>
                            </div>
                            <div class="form-group">
                                <label>Gender:</label>
                                <input name="gender" type="text" class="form-control" placeholder="EX: 01/01/2000" value="<?=$user->gender?>" required>
                            </div>
                            <div class="form-group">
                                <label>Address:</label>
