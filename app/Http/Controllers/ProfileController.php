...
class ProfileController extends Controller
{
    ...
    {
        return view('profile.editProfileDetails', [
            'user' => $request->user(),
        ]);
    }
    ...
    public function pictureInsert(Request $req)
    {
            ...
            if($req->hasFile('image')){
                ...
                $file->move('uploads/images/profiles', $filename);
    ...
    public function pictureUpdate(Request $request)
    {
        ...
        if($request->hasFile('image')){
            $des = public_path('uploads/images/profiles/'.$request->oldimage);
            if(File::exists($des))
            {
                File::delete($des);
            }
    ...
    public function pictureRemove(Request $req)
    {
        ...
        $image_path = public_path('uploads/images/profiles/'.$profile->profile_picture);
